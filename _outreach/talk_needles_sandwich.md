...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/needle_vs_haystack.png" title="Needle vs Haystack slide" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/simulation_of_collisions.png" title="Monte Carlo simulations" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/signal_vs_bkg_plot_explained.png" title="Plot comparison" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
