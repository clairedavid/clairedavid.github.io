...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/surf.jpg" title="SURF" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/surf_visitor.jpg" title="Sanford Lab Homestake Visitor Center" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/neutrino_day_theater.jpg" title="Opera House" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/neutrino_day_kids.jpg" title="Kids attending Neutrino Day 2022" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
