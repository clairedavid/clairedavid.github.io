...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/standard_model_shelves.png" title="dune schematics" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/atlas_event_display.png" title="atlas event display" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/dune_sideview.png" title="standard model" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
