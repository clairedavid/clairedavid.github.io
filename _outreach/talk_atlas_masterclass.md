...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/what_particles_physicists_do.png" title="What Particle Physicists Do" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/quadrivector.png" title="Quadrivectors" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/Z_bump.png" title="Z Bump" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
