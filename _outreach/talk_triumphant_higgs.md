...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/atlas_collision.gif" title="ATLAS Collision" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/Higgs_bump_simplified_plot.png" title="A simplified graph to explain the real discovery plots" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="float-right w-50 p-1">
    {% include figure.html path="assets/img/HiggsGammaGamma.gif" title="Animated plot H → γγ" class="img-fluid rounded z-depth-1" %}
</div> 
